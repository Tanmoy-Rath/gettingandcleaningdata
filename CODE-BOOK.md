...
[317] * **`[319] fBodyAcc-bandsEnergy()-1,8`**          
[318] * **`[320] fBodyAcc-bandsEnergy()-9,16`**         
[319] * **`[321] fBodyAcc-bandsEnergy()-17,24`**        
[320] * **`[322] fBodyAcc-bandsEnergy()-25,32`**        
[321] * **`[323] fBodyAcc-bandsEnergy()-33,40`**        
[322] * **`[324] fBodyAcc-bandsEnergy()-41,48`**        
[323] * **`[325] fBodyAcc-bandsEnergy()-49,56`**        
[324] * **`[326] fBodyAcc-bandsEnergy()-57,64`**        
[325] * **`[327] fBodyAcc-bandsEnergy()-1,16`**         
[326] * **`[328] fBodyAcc-bandsEnergy()-17,32`**        
[327] * **`[329] fBodyAcc-bandsEnergy()-33,48`**        
[328] * **`[330] fBodyAcc-bandsEnergy()-49,64`**        
[329] * **`[331] fBodyAcc-bandsEnergy()-1,24`**         
[330] * **`[332] fBodyAcc-bandsEnergy()-25,48`**        
[331] * **`[333] fBodyAcc-bandsEnergy()-1,8`**          
[332] * **`[334] fBodyAcc-bandsEnergy()-9,16`**         
[333] * **`[335] fBodyAcc-bandsEnergy()-17,24`**        
[334] * **`[336] fBodyAcc-bandsEnergy()-25,32`**        
[335] * **`[337] fBodyAcc-bandsEnergy()-33,40`**        
[336] * **`[338] fBodyAcc-bandsEnergy()-41,48`**        
[337] * **`[339] fBodyAcc-bandsEnergy()-49,56`**        
[338] * **`[340] fBodyAcc-bandsEnergy()-57,64`**        
[339] * **`[341] fBodyAcc-bandsEnergy()-1,16`**         
[340] * **`[342] fBodyAcc-bandsEnergy()-17,32`**        
[341] * **`[343] fBodyAcc-bandsEnergy()-33,48`**        
[342] * **`[344] fBodyAcc-bandsEnergy()-49,64`**        
[343] * **`[345] fBodyAcc-bandsEnergy()-1,24`**         
[344] * **`[346] fBodyAcc-bandsEnergy()-25,48`**        
...
[396] * **`[398] fBodyAccJerk-bandsEnergy()-1,8`**      
[397] * **`[399] fBodyAccJerk-bandsEnergy()-9,16`**     
[398] * **`[400] fBodyAccJerk-bandsEnergy()-17,24`**    
[399] * **`[401] fBodyAccJerk-bandsEnergy()-25,32`**    
[400] * **`[402] fBodyAccJerk-bandsEnergy()-33,40`**    
[401] * **`[403] fBodyAccJerk-bandsEnergy()-41,48`**    
[402] * **`[404] fBodyAccJerk-bandsEnergy()-49,56`**    
[403] * **`[405] fBodyAccJerk-bandsEnergy()-57,64`**    
[404] * **`[406] fBodyAccJerk-bandsEnergy()-1,16`**     
[405] * **`[407] fBodyAccJerk-bandsEnergy()-17,32`**    
[406] * **`[408] fBodyAccJerk-bandsEnergy()-33,48`**    
[407] * **`[409] fBodyAccJerk-bandsEnergy()-49,64`**    
[408] * **`[410] fBodyAccJerk-bandsEnergy()-1,24`**     
[409] * **`[411] fBodyAccJerk-bandsEnergy()-25,48`**    
[410] * **`[412] fBodyAccJerk-bandsEnergy()-1,8`**      
[411] * **`[413] fBodyAccJerk-bandsEnergy()-9,16`**     
[412] * **`[414] fBodyAccJerk-bandsEnergy()-17,24`**    
[413] * **`[415] fBodyAccJerk-bandsEnergy()-25,32`**    
[414] * **`[416] fBodyAccJerk-bandsEnergy()-33,40`**    
[415] * **`[417] fBodyAccJerk-bandsEnergy()-41,48`**    
[416] * **`[418] fBodyAccJerk-bandsEnergy()-49,56`**    
[417] * **`[419] fBodyAccJerk-bandsEnergy()-57,64`**    
[418] * **`[420] fBodyAccJerk-bandsEnergy()-1,16`**     
[419] * **`[421] fBodyAccJerk-bandsEnergy()-17,32`**    
[420] * **`[422] fBodyAccJerk-bandsEnergy()-33,48`**    
[421] * **`[423] fBodyAccJerk-bandsEnergy()-49,64`**    
[422] * **`[424] fBodyAccJerk-bandsEnergy()-1,24`**     
[423] * **`[425] fBodyAccJerk-bandsEnergy()-25,48`**    
...
[475] * **`[477] fBodyGyro-bandsEnergy()-1,8`**         
[476] * **`[478] fBodyGyro-bandsEnergy()-9,16`**        
[477] * **`[479] fBodyGyro-bandsEnergy()-17,24`**       
[478] * **`[480] fBodyGyro-bandsEnergy()-25,32`**       
[479] * **`[481] fBodyGyro-bandsEnergy()-33,40`**       
[480] * **`[482] fBodyGyro-bandsEnergy()-41,48`**       
[481] * **`[483] fBodyGyro-bandsEnergy()-49,56`**       
[482] * **`[484] fBodyGyro-bandsEnergy()-57,64`**       
[483] * **`[485] fBodyGyro-bandsEnergy()-1,16`**        
[484] * **`[486] fBodyGyro-bandsEnergy()-17,32`**       
[485] * **`[487] fBodyGyro-bandsEnergy()-33,48`**       
[486] * **`[488] fBodyGyro-bandsEnergy()-49,64`**       
[487] * **`[489] fBodyGyro-bandsEnergy()-1,24`**        
[488] * **`[490] fBodyGyro-bandsEnergy()-25,48`**       
[489] * **`[491] fBodyGyro-bandsEnergy()-1,8`**         
[490] * **`[492] fBodyGyro-bandsEnergy()-9,16`**        
[491] * **`[493] fBodyGyro-bandsEnergy()-17,24`**       
[492] * **`[494] fBodyGyro-bandsEnergy()-25,32`**       
[493] * **`[495] fBodyGyro-bandsEnergy()-33,40`**       
[494] * **`[496] fBodyGyro-bandsEnergy()-41,48`**       
[495] * **`[497] fBodyGyro-bandsEnergy()-49,56`**       
[496] * **`[498] fBodyGyro-bandsEnergy()-57,64`**       
[497] * **`[499] fBodyGyro-bandsEnergy()-1,16`**        
[498] * **`[500] fBodyGyro-bandsEnergy()-17,32`**       
[499] * **`[501] fBodyGyro-bandsEnergy()-33,48`**       
[500] * **`[502] fBodyGyro-bandsEnergy()-49,64`**       
[501] * **`[503] fBodyGyro-bandsEnergy()-1,24`**        
[502] * **`[504] fBodyGyro-bandsEnergy()-25,48`**       
