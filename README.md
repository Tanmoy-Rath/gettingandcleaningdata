...
'data.frame':	10299 obs. of  66 variables:
 $ tBodyAcc-mean()-Z         : num  0.289 0.278 0.28 0.279 0.277 ...
 $ tBodyAcc-std()-X          : num  -0.0203 -0.0164 -0.0195 -0.0262 -0.0166 ...
 $ tBodyAcc-std()-Y          : num  -0.133 -0.124 -0.113 -0.123 -0.115 ...
 $ tBodyAcc-std()-Z          : num  -0.995 -0.998 -0.995 -0.996 -0.998 ...
 $ tBodyAcc-mad()-X          : num  -0.983 -0.975 -0.967 -0.983 -0.981 ...
 $ tBodyAcc-mad()-Y          : num  -0.914 -0.96 -0.979 -0.991 -0.99 ...
 $ tGravityAcc-mean()-Z      : num  0.963 0.967 0.967 0.968 0.968 ...
 $ tGravityAcc-std()-X       : num  -0.141 -0.142 -0.142 -0.144 -0.149 ...
```
